							...
							<div class="modal-dialog modal-lg">
									...
									<div class="modal-body">
										<form action="teacher.php" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="text" name="cnic" class="form-control" placeholder="Aadhar No" required="">
													</div>
												</div>
											</div>
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="number" name="other_phone" class="form-control" placeholder="Other Phone No" required="">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Upload PG Certificate:</label required="">
                              <input type="file" name="fa_certificate" class="form-control">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label for="exampleInputEmail1">Mphil Complition Date: </label>
														<input type="date" name="ba_complition_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Mphil Awarded Date:</label>
														<input type="date" name="ba_awarded_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Upload Mphil Certificate:</label>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label for="exampleInputEmail1">Ph.d Complition Date: </label>
														<input type="date" name="ma_complition_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Ph.d Awarded Date:</label>
														<input type="date" name="ma_awarded_date" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
														<label for="exampleInputPassword1">Upload Ph.d Certificate:</label>
